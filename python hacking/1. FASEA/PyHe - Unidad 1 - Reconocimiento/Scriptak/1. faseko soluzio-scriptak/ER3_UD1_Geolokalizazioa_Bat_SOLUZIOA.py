...
if __name__ == '__main__':
    ...
    if obtener_ciudad(latitud, longitud) is not None:
        print("La ciudad corresponidente a las coordenadas introducidas es:",obtener_ciudad(latitud, longitud))
    else:
        print("No se ha podido obtener una ciudad para las coordenadas introducidas")
    exit()
