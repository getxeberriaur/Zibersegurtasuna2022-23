...
if __name__ == "__main__": 
   try: 
      ...
      #Pedimos al usuario que introduzca la ruta de un archivo que contenga la captura
      while not fichero_correcto:
          ruta_fichero = input('>> Introduce la ruta al archivo con la captura (.pcap): ')
          if ruta_fichero != "":
   ...
   try: 
       ...
       for paquete in captura:
           ...
           if 'icmp' in paquete:
              #Guardamos en la variable "resultado" la cadena de caracteres generada por la función "conversacion_red"
