...
if __name__ == '__main__':
    ...
    try:
        #(◕‿−)Rellenar a partir de ahora todo lo que falta
        ...
        #(◕‿−)Al crear una instancia de PortScanner estamos preparando un objeto que se utilizará para realizar operaciones de escaneo de puertos en el host objetivo       
        ...
        #(◕‿−)Creamos una lista que contenga los datos formateados que nos devuelve la función formateoNmapscan. La ordenamos por IP
        ...
        for host in estructuraNmap:
            #Escribimos cada dirección IP escaneada en el archivo
           
            #(◕‿−)Dentro de cada host, tratamos uno por uno cada puerto

                #(◕‿−)Escribimos en el archivo el número del puerto, el nombre del servicio y la versión del servicio
                ...
                if puertoOpen.scriptOutput is not None: 
                    ...
                    #(◕‿−)Llamamos a la función escribir_vulnerabilidades
