...
if __name__ == '__main__':
    ...
    try:
        ...
        informacion_complejidad = re.findall(r'Password Complexity: (.+)', stdout_texto)
        print ("Información sobre la política de complejidad de la password:")
        print (informacion_complejidad)
